...
# using imageio instead
# based on suggestion in the following post:
# https://stackoverflow.com/questions/19991665/my-scipy-misc-module-appears-to-be-missing-imsave
import imageio
...
def save_samples(iteration, fixed_Y, fixed_X, G_YtoX, G_XtoY, batch_size=16, sample_dir='samples_cyclegan'):
    ...
    img_uint8 = merged.astype(np.uint8) # need to convert to uint8 to prevent lossy conversion warning
                                        # see the following post: https://stackoverflow.com/questions/57618301/convert-image-from-float64-to-uint8-makes-the-image-look-darker
